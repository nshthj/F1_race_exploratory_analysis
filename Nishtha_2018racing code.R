...
princi_cmp=prcomp(combined_data_na_removed,scale=TRUE)
summary(princi_cmp)
...
library(corrplot)
corrplot(CR$correlations,type = "upper",method = "square",title = "Correlation Plot F1 Races 2018",tl.col = "black",mar = c(1,1,5,1))
